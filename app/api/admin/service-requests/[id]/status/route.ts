...
import { updateServiceRequestStatusForAdmin } from "@/services/project-service";
...
export async function POST(request: Request, context: { params: Promise<{ id: string }> }) {
  try {
    ...
    const ret = await updateServiceRequestStatusForAdmin({
      requestId: id,
    ...
    const message = error instanceof Error ? error.message : "管理端服务申请状态更新失败";
